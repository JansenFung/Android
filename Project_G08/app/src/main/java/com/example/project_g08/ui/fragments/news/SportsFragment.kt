...
import com.example.project_g08.databinding.FragmentSportsBinding
...
class SportsFragment : Fragment(), OnNewsClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var adapter = NewsAdapter(requireContext(), NewsList, this)
        ...
        //Retrieve local news from API
        viewLifecycleOwner.lifecycleScope.launch {
            val newsListFromAPI: News = api.getAllSports()
            NewsList.clear()
