...
import com.example.project_g08.databinding.FragmentSearchBarBinding
import com.google.firebase.auth.FirebaseAuth
import kotlinx.coroutines.launch

class SearchBar : Fragment() , OnNewsClickListener {
    ...
    private val args : SearchBarArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var api: IAPIResponse = RetrofitInstance.retrofitService
         ...
         //Retrieve news from a given category
        viewLifecycleOwner.lifecycleScope.launch {
            val newsListFromAPI: News = api.getByCategory(args.category.lowercase())

            if(newsListFromAPI.status=="error"){
        ...
        val simpleCallback: ItemTouchHelper.SimpleCallback =
            object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
                ...
                //Save the selected news into user favorite list
